...
With the exception of the cohort descriptive table, the data analysed in this report are based upon all patients who were virally sequenced in Scotland between the specimen collection date of the first AY4.2 case in Scotland - 8th June 2021 - and the last date of hospital admission or discharge amongst all who were virally sequenced - 25th October 2021.
...
z %>%  ggplot(aes(x=admission_date, y=N, colour = variant)) + geom_line() +
  labs(x="Admission Date",y ="Number", colour="Variant", title="Emergency Hospital Admissions for Covid by day")
```
...
z %>%  ggplot(aes(x=Collection_Date, y=N, colour=variant)) + geom_line() +
  labs(x="Specimen Date",y ="Number", title="Number of cases per day", colour="Variant") + scale_y_log10()
```
