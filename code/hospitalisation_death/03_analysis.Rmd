...
The main analyis in this report is based upon all patients who were virally sequenced in Scotland between the specimen collection date of the first AY4.2 case in Scotland - 8th June 2021 - and the last date of hospital admission or discharge amongst all who were virally sequenced - 25th October 2021.
...
knitr::include_graphics('../../output/pos_tests_by_day.png')
...
# z %>%  ggplot(aes(x=specimen_date, y=N, colour=variant)) + geom_line() +
#   labs(x="Specimen Date",y ="Number", title="Number of cases per day", colour="Variant") + scale_y_log10()
```
